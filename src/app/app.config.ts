...
import { AUTH_USE_CASE, DASHBOARD_USE_CASE, MODULE_USE_CASE, LESSON_USE_CASE, PROGRESS_USE_CASE, AI_USE_CASE, VOICE_USE_CASE, VOCABULARY_USE_CASE, USER_USE_CASE, LANGUAGE_USE_CASE, AUTH_REPOSITORY, LANGUAGE_REPOSITORY, MODULE_REPOSITORY, LESSON_REPOSITORY, PROGRESS_REPOSITORY, AI_REPOSITORY, VOICE_REPOSITORY, VOCABULARY_REPOSITORY, USER_REPOSITORY, TOKEN_STORAGE } from './di/tokens';
...
import { VoiceUseCase } from './core/use-cases/voice.use-case';
...
import { VoiceApiAdapter } from './infrastructure/api/voice-api.adapter';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    { provide: VOICE_REPOSITORY, useClass: VoiceApiAdapter },
    ...
    { provide: VOICE_USE_CASE, useClass: VoiceUseCase },
