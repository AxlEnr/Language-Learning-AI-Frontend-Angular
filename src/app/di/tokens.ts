...
import { IAuthUseCase, IDashboardUseCase, IModuleUseCase, ILessonUseCase, IProgressUseCase, IAIUseCase, IVoiceUseCase, IVocabularyUseCase, IUserUseCase, ILanguageUseCase } from '../core/domain/ports/in';
import { IAuthRepository, ILanguageRepository, IModuleRepository, ILessonRepository, IProgressRepository, IAIRepository, IVoiceRepository, IVocabularyRepository, IUserRepository, ITokenStorage } from '../core/domain/ports/out';
...
export const VOICE_USE_CASE = new InjectionToken<IVoiceUseCase>('VOICE_USE_CASE');
...
export const VOICE_REPOSITORY = new InjectionToken<IVoiceRepository>('VOICE_REPOSITORY');
